...
public class SellerFormController implements Initializable {
	...
	@FXML
	private Label labelErrorBD;

	@FXML
	private Label labelErrorBS;
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		labelErrorBS.setText((fields.contains("baseSalary")) ? errors.get("baseSalary") : "");
		
		labelErrorBD.setText((fields.contains("birthDate")) ? errors.get("birthDate") : "");
	}
